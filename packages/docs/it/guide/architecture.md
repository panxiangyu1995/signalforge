...
Yoga di Meta fornisce il calcolo del layout CSS flexbox e grid tramite un [fork](https://github.com/panxiangyu1995/yoga/tree/grid) con supporto CSS Grid. Un adattatore sottile mappa i nomi delle proprietà Figma agli equivalenti Yoga:
