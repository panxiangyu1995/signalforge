...
Yoga de Meta proporciona cálculo de layout CSS flexbox y grid a través de un [fork](https://github.com/panxiangyu1995/yoga/tree/grid) con soporte CSS Grid. Un adaptador delgado mapea nombres de propiedades de Figma a equivalentes de Yoga:
